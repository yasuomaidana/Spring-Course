INSERT INTO fc_tournament ("name", country)
VALUES
('Ball','Russia'),
('Foot','UK');

INSERT INTO fc_team ("name", players)
VALUES
('First', 43),
('Second', 50);
...
INSERT INTO fc_coach (id, id_team, surname, "name", age, experience)
VALUES
(1,1,'FirstCoach','Name',55,20),
(2,2,'SecondCoach','NameMore',64,30);

INSERT INTO fc_news (id, "name", content)
VALUES
...
INSERT INTO fc_player (surname, "name", height, weight, age)
VALUES
...
INSERT INTO fc_event ("name", content)
VALUES
